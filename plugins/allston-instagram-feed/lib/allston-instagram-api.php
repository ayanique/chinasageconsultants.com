...
include 'allston-instagram-helper.php';

/**
 * Class AllstonInstagramApi
 */
class AllstonInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var AllstonInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var AllstonInstagramHelper
     */
    private $helper;

    const CODE_OPTION_NAME = 'allston_instagram_code';
    const USER_ID_OPTION_NAME = 'allston_instagram_user_id';
    const ACCESS_TOKEN_OPTION_NAME = 'allston_instagram_access_token';
    const CODE_REDIRECT_URI_OPTION_NAME = 'allston_instagram_code_redirect_uri';
    ...
    private function __construct() {
        ...
        $this->helper = new AllstonInstagramHelper();
    }
     ...
     * @return string
     *
     * @see AllstonInstagramApi::buildCurrentPageURI()
     */
     ...
     *
     * @see AllstonInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see AllstonInstagramApi::getAccessToken()
     */
