...
/**
 * Class AllstonInstagramHelper
 */
class AllstonInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines allston_instagram_image_atts filter
     * @param array $image associative array of image informations
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('allston_instagram_image_atts',
            array(
                'class' => $imageSize,
