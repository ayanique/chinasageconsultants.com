<?php
if ( ! function_exists( 'allston_eltdf_init_google_fonts_array' ) ) {
    function allston_eltdf_init_google_fonts_array() {
        ...
        $allston_eltdf_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'allston_eltdf_init_google_fonts_array');
}