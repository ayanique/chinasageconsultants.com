...
namespace AllstonCore\CPT\Shortcodes\PortfolioCategoryList;
...
class PortfolioCategoryList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio Category List', 'allston-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Items Per Page', 'allston-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio category list. Default value is 6', 'allston-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio category list', 'allston-core' )
						),
						array(
							'type'       => 'dropdown',
	...
	public function render( $atts, $content = null ) {
		...
		$html = allston_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'portfolio-category-holder', '', $params );
	...
	public function getHolderClasses( $params, $args ) {
		...
		switch ( $number_of_columns ):
			case '1':
				$classes[] = 'eltdf-pcl-one-column';
				break;
			case '2':
				$classes[] = 'eltdf-pcl-two-columns';
				break;
			case '3':
				$classes[] = 'eltdf-pcl-three-columns';
				break;
			case '4':
				$classes[] = 'eltdf-pcl-four-columns';
				break;
			case '5':
				$classes[] = 'eltdf-pcl-five-columns';
				break;
			default:
				$classes[] = 'eltdf-pcl-three-columns';
				break;
