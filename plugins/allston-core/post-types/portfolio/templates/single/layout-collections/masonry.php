<?php
$masonry_classes = '';
$number_of_columns = allston_eltdf_get_meta_field_intersect('portfolio_single_masonry_columns_number');
if(!empty($number_of_columns)) {
	$masonry_classes .= ' eltdf-ps-'.$number_of_columns.'-columns';
}
$space_between_items = allston_eltdf_get_meta_field_intersect('portfolio_single_masonry_space_between_items');
if(!empty($space_between_items)) {
	$masonry_classes .= ' eltdf-'.$space_between_items.'-space';
}
?>
<div class="eltdf-ps-image-holder eltdf-ps-masonry-images eltdf-disable-bottom-space <?php echo esc_attr($masonry_classes); ?>">
