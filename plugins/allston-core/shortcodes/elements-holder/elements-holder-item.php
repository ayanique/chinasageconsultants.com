...
class ElementsHolderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Elements Holder Item', 'allston-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Horizontal Alignment', 'allston-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Vertical Alignment', 'allston-core' ),
							'value'      => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Default (No Animation)', 'allston-core' )   => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 1366px-1600px', 'allston-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'allston-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'allston-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'item_padding_1024_1366',
							'heading'     => esc_html__( 'Padding on screen size between 1024px-1366px', 'allston-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'allston-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'allston-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 768px-1024px', 'allston-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'allston-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'allston-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 680px-768px', 'allston-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'allston-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'allston-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size bellow 680px', 'allston-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'allston-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'allston-core' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = allston_core_get_shortcode_module_template_part( 'templates/elements-holder-item-template', 'elements-holder', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['background_color'] ) && ! empty( $params['background_image'] ) ? 'eltdf-eh-item-with-overlay' : '' ;
