<?php
namespace AllstonCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'allston-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'allston-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'allston-core' ),
							'value'      => array(
								esc_html__( '80/20', 'allston-core' ) => '80',
								esc_html__( '75/25', 'allston-core' ) => '75',
								esc_html__( '66/33', 'allston-core' ) => '66',
								esc_html__( '50/50', 'allston-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px)', 'allston-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'allston-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'allston-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link Target', 'allston-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'allston-core' ),
							'group'      => esc_html__( 'Button Style', 'allston-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_color',
							'heading'    => esc_html__( 'Button Hover Color', 'allston-core' ),
							'group'      => esc_html__( 'Button Style', 'allston-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_background_color',
							'heading'    => esc_html__( 'Button Background Color', 'allston-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'allston-core' ),
							'group'      => esc_html__( 'Button Style', 'allston-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'allston-core' ),
							'group'      => esc_html__( 'Button Style', 'allston-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'allston-core' ),
							'group'      => esc_html__( 'Button Style', 'allston-core' )
						),
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'allston-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'allston-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = allston_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . allston_eltdf_filter_px( $params['button_top_margin'] ) . 'px';
		}
