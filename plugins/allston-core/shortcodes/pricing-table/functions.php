...
if ( ! function_exists( 'allston_core_add_pricing_tables_shortcodes' ) ) {
	function allston_core_add_pricing_tables_shortcodes( $shortcodes_class_name ) {
		$shortcodes = array(
			'AllstonCore\CPT\Shortcodes\PricingTable\PricingTable',
			'AllstonCore\CPT\Shortcodes\PricingTable\PricingTableItem'
		);
	...
	add_filter( 'allston_core_filter_add_vc_shortcode', 'allston_core_add_pricing_tables_shortcodes' );
}
