...
class ImageInteractiveBox implements Lib\ShortcodeInterface {
	private $base;

	function __construct() {
		$this->base = 'eltdf_image_interactive_box';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Image Interactive Box', 'allston-core' ),
					'base'                    => $this->base,
					'as_parent'               => array( 'only' => 'eltdf_interactive_image_box_item' ),
					'content_element'         => true,
					'category'                => esc_html__( 'by ALLSTON', 'allston-core' ),
					'icon'                    => 'icon-wpb-image-interactive-box extended-custom-icon',
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="eltdf-interactive-image-box clearfix ' . esc_attr( $holder_class ) . '">';
