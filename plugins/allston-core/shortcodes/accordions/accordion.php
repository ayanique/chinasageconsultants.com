<?php
namespace AllstonCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'allston-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'allston-core' ) => 'accordion',
								esc_html__( 'Toggle', 'allston-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Boxed', 'allston-core' )  => 'boxed',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'allston-core' ),
							'value'      => array(
								esc_html__( 'Default', 'allston-core' ) => '',
								esc_html__( 'White', 'allston-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = allston_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
