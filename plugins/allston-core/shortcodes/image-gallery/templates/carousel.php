...
<div class="eltdf-image-gallery <?php echo esc_attr($holder_classes); ?>">
	<div class="eltdf-ig-slider eltdf-owl-slider" <?php echo allston_eltdf_get_inline_attrs($slider_data); ?>>
				...
				<div class="eltdf-ig-image-inner">
					...
					<?php } ?>
						<?php if(is_array($image_size) && count($image_size)) :
							echo allston_eltdf_generate_thumbnail($image['image_id'], null, $image_size[0], $image_size[1]);
						else:
