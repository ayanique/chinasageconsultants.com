...
//        echo 'here <strong>sliders_admin.php</strong> ';
		...
		wp_enqueue_style('dzs.dzstoggle', $dzsap->base_url . 'libs/dzstoggle/dzstoggle.css');
		wp_enqueue_script('dzs.dzstoggle', $dzsap->base_url . 'libs/dzstoggle/dzstoggle.js');
...
//           echo  $dzsap->sliders_admin_generate_item($object)
            ...
            <div class="add-btn">
                ...
                <div class="add-btn-new button-secondary"><?php echo esc_html__("Create New Item",'dzsap'); ?></div>
                <div class="add-btn-existing add-btn-existing-media upload-type-audio button-secondary"><?php echo esc_html__("Add From Library",'dzsap'); ?></div>
            </div>
...
'>
      ...
      <div class="feed-con import-folder-con for-feed_mode-import-folder">
        ...
        <div class="dzstoggle toggle1" rel="">
          <div class="toggle-title" style=""><?php echo esc_html__('Import folder', 'dzsap'); ?></div>
          <div class="toggle-content">

            <h4><?php echo esc_html__("Import folder",'dzsap'); ?></h4>
						<?php
						$val = '';
						$lab = 'folder_location';
            ...
            <div class="sidenote"><?php echo esc_html__("input the location of the folder that is storing the mp3s - for example the location of the zoomsounds plugin folder is ",'dzsap'); echo '<strong>'.wp_upload_dir()['basedir'].'</strong>'; ?></div>
            <div class="button-con align-inside-middle">

              <button class="button-secondary btn-import-folder"><?php echo esc_html__("Import folder",'dzsap'); ?></button> <span class="dzsap-dashicon-preloader dashicons dashicons-update"></span>
            </div>
