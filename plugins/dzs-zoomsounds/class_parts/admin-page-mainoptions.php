...
?>
  ...
  <div class="wrap">
    ...
    <a href="<?php echo admin_url('admin.php?page=' . $this->page_mainoptions_link . '&dzsap_shortcode_builder=on'); ?>"
       target="_blank"
       class="button-secondary action"><?php _e('Gallery Generator', 'dzsap'); ?></a>

    <a
      href="<?php echo admin_url('admin.php?page=' . $this->page_mainoptions_link . '&dzsap_shortcode_player_builder=on'); ?>"
      target="_blank"
...
,refresh_tab_height: '1000'
        ...
        <div class="dzs-tab-tobe">
          ...
          <div class="tab-content">
            ...
            <div class="setting">
              <h4 class="label"><?php echo esc_html__('Enable Autobackup', 'dzsap'); ?></h4>
              <?php
            ...
            <?php
            $lab = 'enable_aux_buttons';
            ?>
            <div class="setting">
              <h4 class="label"><?php echo esc_html__('Enable Extra Stats / Delete button', 'dzsap'); ?></h4>
              <?php
              echo DZSHelpers::generate_input_text($lab, array('id' => $lab, 'class' => 'fake-input', 'val' => 'off', 'input_type' => 'hidden'));
              echo '<div class="dzscheckbox skin-nova">
                                        ' . DZSHelpers::generate_input_checkbox($lab, array('id' => $lab, 'class' => 'mainsetting', 'val' => 'on', 'seekval' => $this->mainoptions[$lab])) . '
              ...
              ?>
              <div
                class="sidenote"><?php echo sprintf(esc_html__('enable auxiliarry stats / delete button under each songs to see the stats', 'dzsap')); ?></div>
            </div>
            ...
            <div class="setting">
              ...
              ?>
              <div
                class="sidenote"><?php echo esc_html__('if set to on, download will not be forced', 'dzsap'); ?></div>
            ...
            <div class="setting">
              ...
              ?>
              <div
                class="sidenote"><?php echo __('when your users click on the shared link, this will force autoplay for them', 'dzsap'); ?></div>
            ...
            ?>
            <div class="setting">
              <h4 class="label"><?php echo __('Show only published Audio items in playlists', 'dzsap'); ?></h4>
              <?php $lab = 'show_only_published';
              echo '<div class="dzscheckbox skin-nova">
                                        ' . DZSHelpers::generate_input_checkbox($lab, array('id' => $lab, 'class' => 'mainsetting', 'val' => 'on', 'seekval' => $this->mainoptions[$lab])) . '
                                        <label for="' . $lab . '"></label>
                                    </div>';
              ?>
              <div
                class="sidenote"><?php echo __('only audio items that are published are shown in playlists', 'dzsap'); ?></div>
            </div>
 ...
 ' . DZSHelpers::generate_input_checkbox($lab, array('id' => $lab, 'class' => 'mainsetting', 'val' => 'on', 'seekval' => $this->mainoptions[$lab])) . ' <label for="' . $lab . '"></label>
            ...
            <div class="setting" data-dependency='<?php echo json_encode($dependency); ?>'>
              ...
              <div
                class="sidenote"><?php echo __("the waveform bars size / the number of bars on screen") . ''; ?></div>
            </div>
            ...
            <div class="setting" data-dependency='<?php echo json_encode($dependency); ?>'>
              ...
              <div class="sidenote"><?php echo esc_html__("spacing between bars") . ''; ?></div>
            </div>
            ...
            <div class="setting" data-dependency='<?php echo json_encode($dependency); ?>'>
              ...
              <div
                class="sidenote"><?php echo __("normalize the waves to look like they have continuity , or disable normalizing to make the waveforms follow the real sound") . ''; ?></div>
            </div>
            ...
            $val = 'off';
            if (isset($this->mainoptions[$lab]) && $this->mainoptions[$lab]) {
              $val = $this->mainoptions[$lab];
            }
            ?>
            <div class="setting">
              <h4 class="label"><?php echo __('Exclude audio items from Search', 'dzsap'); ?></h4>
              <?php
            ...
            ?>
            <div class="setting">
              <h4 class="label"><?php echo __('Pause method', 'dzsap'); ?></h4>
              <?php
            ...
            <div class="setting">
              ...
              ?>
              <div class="sidenote"><?php echo esc_html__('Replace with any html. Default is - ', 'dzsap'); ?>
        ...
        <div class="dzs-tab-tobe">
          ...
          <div class="tab-content">
            ...
            <div class="setting">
              <h4
                class="label"><?php echo __('Single Product ZoomSounds Preview - Optional shortcode', 'dzsap'); ?></h4>
              <?php
        ...
        <div class="dzs-tab-tobe">
          <div class="tab-menu with-tooltip">
            <i class="fa fa-shopping-cart"></i> <?php echo esc_html__("WooCommerce Loops", 'dzsap') ?>
          </div>
          <div class="tab-content">
            <br>
            ...
            <div class="setting">
              ...
              <div
                class="sidenote"><?php echo __("this will output a preview player in the woocommerce product page if a track is set in the zoomsounds settings of the product."); ?></div>
            </div>
            ...
            <div class="setting">
              ...
              <div
                class="sidenote"><?php echo __("this will output a preview player in the woocommerce shop page if a track is set in the zoomsounds settings of the product."); ?></div>
            </div>
            ...
            <div class="setting">
              ...
              <div
                class="sidenote"><?php echo __("( beta ) try to hide real url and deny access for direct download - will cause problems in seeking the mp3 progress"); ?></div>
            </div>
            ...
            <div class="setting">
              ...
              <div
                class="sidenote"><?php echo __("this controls wheter the sample time start / end reflect the part of the real track or the preview track"); ?>
                <a
            ...
            <div class="setting">
              ...
              <div
                class="sidenote"><?php echo __("this will output a preview player in the woocommerce single product page if a track is set in the zoomsounds settings of the product."); ?></div>
            </div>
        ...
        <div class="dzs-tab-tobe">
          ...
          <div class="tab-content">
            ...
            <div
              class="sidenote"><?php echo __("Note that integral translation of the plugin can be done by installing the WPML plugin. Or by using PO Edit and modifying the core wordpress language. We provide next only a few strings to be translated, for convenience:"); ?></div>
        ...
        <div class="dzs-tab-tobe">
          ...
          <div class="tab-content">
            ...
            echo '<div class="setting">
                    <h4 class="label">' . esc_html__('Waveform Progress Color', 'dzsap') . '</div>
        ...
        <div class="dzs-tab-tobe">
          ...
          <div class="tab-content">
            ...
            <div class="setting">
              ...
              <div class="clear"></div>
              <div
                class='sidenote'><?php echo sprintf(__('allows for %s meta options for these post types', 'dzsap'), 'ZoomSounds'); ?></div>
              <div class="clear"></div>
            </div>
            ...
            <div class="setting">
              ...
              <h4
                class="setting-label"><?php echo sprintf(__('Optional Meta Box %s Label', 'dzsap'), '<strong>' . $nr . '</strong>'); ?></h4>
              <?php
              ...
              <div
                class="sidenote"><?php echo __("place a optional meta box label - that can be replaced with in the zoomsounds extra html"); ?></div>
            </div>
        ...
        <div class="dzs-tab-tobe">
          ...
          <div class="tab-content">
            ...
            <div class="setting">
              ...
              <div
                class="sidenote"><?php echo __('the install php version, 5.4 or greater required for facebook api'); ?></div>
            </div>
...
//echo $query; print_r($val);
            ...
            <div class="setting">
              ...
              <h4 class="setting-label"><?php echo __("Backup log"); ?></h4>
        ...
        <div class="dzs-tab-tobe">
          <div class="tab-menu with-tooltip">
            <i class="fa fa-gears"></i> <?php echo __("Amazon s3") ?>
          </div>
          <div class="tab-content">
            ...
            if (file_exists(dirname(__FILE__) . '/aws/aws-autoloader.php')) {
              ...
              <div class="setting">
                ...
                ?>
                <div
                  class="sidenote"><?php echo wp_kses(sprintf(__("region code ( ie. %s ) - full list %shere%s", 'dzsap'),
        ...
        <div class="dzs-tab-tobe">
          ...
          <div class="tab-content">
            ...
            <div class="setting">
              ...
              <p
                class="sidenote"><?php echo __('Automatically identify all the single players in the page', 'dzsap'); ?></p>
            </div>
...
' . DZSHelpers::generate_input_checkbox($lab, array('id' => $lab, 'class' => 'mainsetting', 'val' => 'on', 'seekval' => $this->mainoptions[$lab])) . '
 <label for="' . $lab . '"></label>
    ...
    <label for="' . $lab . '"></label>
            ...
            <div class="setting">
              <h4 class="label"><?php echo esc_html__('Enable Powerpress Support', 'dzsap'); ?></h4>
            ...
            <div class="setting">
              <h4 class="label"><?php echo 'Powerpress - ';
                echo __(' try to read category data ', 'dzsap');
                echo 'xml'; ?></h4>
            ...
            <div class="setting">
              ...
              $vpconfigs_arr = array(
                array('lab' => esc_html__("Off", 'dzsap'), 'val' => 'off')
              );
              ...
              <div
                class="sidenote"><?php echo __("select a audio player configuration with which to replace the default wordpress player"); ?></div>
            </div>
            ...
            <div class="setting">
              ...
              <?php echo dzsap_misc_input_textarea($lab, array('val' => '', 'seekval' => stripslashes($this->mainoptions[$lab]))); ?>
            ...
            <div class="setting">
              ...
              <div
                class="sidenote"><?php echo __("only if a player configuration is selected for the default player, then this will play in the footer player"); ?></div>
            </div>


            <div class="setting">
              <h4 class="label"><?php echo esc_html__('Load local fontawesome', 'dzsap'); ?></h4>
              <?php


              $lab = 'script_init_method';

              $options_arr = array(
                array(
                  'lab' => __("Javascript Safe"),
                  'val' => 'javascript_safe'
                ),
                array(
                  'lab' => __("Javascript Array"),
                  'val' => 'javascript_array'
                ),
              );


              echo DZSHelpers::generate_select($lab, array('class' => 'vpconfig-select styleme', 'options' => $options_arr, 'seekval' => $this->mainoptions[$lab])); ?>
            ...
            <div class="setting">
              ...
              <div
                class="sidenote"><?php echo esc_html__("higher is more precise, but occupies more storage space", 'dzsap'); ?></div>
            </div>
      ...
      ?>">
        ...
        <form action="admin.php?page=dzsap-mo" method="get">
          ...
          <div class="setting">
            ...
            ?>
            <div
              class="sidenote"><?php echo __("( donor mp3 ) ( optional ) get pcm data from another mp3 url"); ?></div>
          </div>
          <button class="button-secondary" name="dzsap_action"
                  value="generate_wave"><?php echo __("Get Track Data"); ?></button>
...
';
        ...
        <div class="sidenote"><?php echo __("copy the text from above in the box below to overwrite pcm data"); ?>
          - <?php echo sprintf(__("in order to save the pcm data fro mthe flash tool, click the text above and press %s ( %s ) "), "ctrl + a", __("Select All")); ?></div>
    ...
    <div class="dzstoggle toggle1">
      ...
      <div class="toggle-content" style="">
        ...
        <form class="mainsettings" method="POST">
          ...
          <button
            class="button-secondary btn-delete-waveform-data"><?php echo __('Delete waveform data', 'dzsap'); ?></button>
        </form>
        <br>
        <form class="mainsettings" method="POST">
          <?php
          ...
          <input type="hidden" name="nonce" value="<?php echo $nonce; ?>"/>
          <button
            class="button-secondary btn-delete-waveform-data"><?php echo __('Delete total times', 'dzsap'); ?></button>
        </form>
        <br>
