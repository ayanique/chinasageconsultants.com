        ...
        <div class="dzs-col-md-4">
          ...
          <div class="white-bg">
            ...
            <form action="https://zoomthe.me/updater_dzsap/check_activation.php" class="mainsettings activate-form"
              ...
              <?php
              ?>
              <div class="sidenote"><?php echo __("Unlock ");
                echo " ZoomSounds";
                echo __(" for premium benefits like one click sample galleries install and autoupdate.") ?></div><?php
              echo '
            
                <div class="setting">
                    <div class="label">' . __("Purchase Code", 'dzsap') . '</div>
                    ' . dzsap_misc_input_text($purchaseCodeDbName, array('val' => '', 'seekval' => $this->mainoptions[$purchaseCodeDbName], 'class' => $extra_class, 'extra_attr' => $extra_attr)) . $disable_button . '
