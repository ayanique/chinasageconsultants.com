  ...
  <div class="wrap">
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'dzsap_update_request') {
      ...
      if (isset($_POST['dzsap_purchase_code'])) {
        ...
        update_option($dzsap->dbname_options, $auxarray);
      }
    ...
    echo '
                <div class="setting">
                    ...
                    <div class="sidenote">' . __('You can  <a rel="nofollow" href="https://lh5.googleusercontent.com/-o4WL83UU4RY/Unpayq3yUvI/AAAAAAAAJ_w/HJmso_FFLNQ/w786-h1179-no/puchase.jpg" target="“_blank”">find it here</a> ', 'dzsap') . '</div>
                </div>';
