...
$this->videoplayerconfig .= '
        <div class="dzs-tabs auto-init-from-vpconfig">
                ...
                <div class="dzs-tab-tobe"><div class="tab-menu with-tooltip">
                        ...
                        <span class="tab-title-label">' . __("General") . '</span>
...
$this->videoplayerconfig .= '<div class="dzs-tab-tobe tab-disabled"><div class="tab-menu ">
                        ...
                        <span class="tab-title-label">' . esc_html__("Colors", 'dzsap') . '</span>
                    </div><div class="tab-content">';


$lab = '0-settings-' . 'colorhighlight';

$this->videoplayerconfig .= '<div class="setting type_all"><div class="label">' . __("Highlight Color") . '</div><input type="text" name="' . $lab . '" class="textinput mainsetting colorpicker-nohash with_colorpicker" value=""/><div class="picker-con"><div class="the-icon"></div><div class="picker"></div></div><div class="sidenote">' . __('Only for <strong>skin-wave</strong>', 'dzsap') . '</div></div>';
...
$this->videoplayerconfig .= '<div class="dzs-tab-tobe tab-disabled"><div class="tab-menu ">
                        ...
                        <span class="tab-title-icon"><i class="fa fa-paint-brush"></i></span>
                        <span class="tab-title-label">' . __("Styling") . '</span>
                    </div><div class="tab-content">
...
?>
  ...
  <div class="setting">
    ...
    <div
      class="sidenote"><?php echo __("spacing between bars - leave nothing here and this will come from global") . ''; ?></div>
  </div>
...
$this->videoplayerconfig .= '<div class="setting styleme">
            <div class="setting-label">' . __('Timer indicators are static', 'dzsap') . '</div>
...
$this->videoplayerconfig.='
        ...
        <div class="setting setting-skin-layout styleme">
            ...
            <ul class="dzs-style-me-feeder">
                ...
                <div class="bigoption">
                    <span class="option-con"><img src="' . $this->base_url . 'assets/admin/skin-wave-mode--normal.png"><span class="option-label">' . esc_html__('Mode normal', 'dzsap') . '</span></span>
                </div>
                <div class="bigoption">
                    <span class="option-con"><img src="' . $this->base_url . 'assets/admin/skin-wave-mode--small.png"><span class="option-label">' . esc_html__('Mode slick', 'dzsap') . '</span></span>
                </div>
                <div class="bigoption">
                    <span class="option-con"><img src="' . $this->base_url . 'assets/admin/skin-wave-mode--alternate.png"><span class="option-label">' . esc_html__('Mode alternate', 'dzsap') . '</span></span>
                </div>
                <div class="bigoption">
                    <span class="option-con"><img src="' . $this->base_url . 'assets/admin/skin-wave-mode--bigwavo.png"><span class="option-label">' . esc_html__('Mode big wavo', 'dzsap') . '</span></span>
                </div>
                <div class="bigoption">
                    <span class="option-con"><img src="' . $this->base_url . 'assets/admin/skin-wave-mode--nocontrols.png"><span class="option-label">' . esc_html__('Just wave', 'dzsap') . '</span></span>
                </div>
            </ul>
        ...
        <div class="setting styleme">
            ...
            <select class="textinput mainsetting styleme" name="0-settings-skinwave_wave_mode_canvas_mode">
                ...
                <option value="reflecto">' . __('Wave ( reflecto )', 'dzsap') . '</option>
            </select>
        ...
        <div class="setting styleme">
            ...
            <ul class="dzs-style-me-feeder">
                ...
                <div class="bigoption">
                    <span class="option-con"><img src="http://i.imgur.com/oVUgjff.png"><span class="option-label">' . esc_html__('Aspect noir', 'dzsap') . '</span></span>
                </div>
                <div class="bigoption">
                    <span class="option-con"><img src="' . $this->base_url . 'assets/svg/skin_aria.svg"><span class="option-label">' . esc_html__('Aspect noir filled', 'dzsap') . '</span></span>
                </div>
                <div class="bigoption">
                    <span class="option-con"><img src="' . $this->base_url . 'assets/svg/skin_default.svg"><span class="option-label">' . esc_html__('Aspect noir stroked', 'dzsap') . '</span></span>
                </div>
            </ul>
        ...
        <div class="setting styleme">
            ...
            <div class="sidenote">' . __('set this to <strong>on</strong> to get better animation on changing songs ( recommended only if you are changing songs with a footer player ) ', 'dzsap') . '</div>
                        ...
                        <span class="tab-title-label">' . __("Misc") . '</span>
                    </div><div class="tab-content">
        ...
        <div class="setting type_all">
            <div class="setting-label">' . __('Extra CSS', 'dzsap') . '</div>
            <textarea rows="5" type="text" style="width: 100%;" class="textinput mainsetting" name="0-settings-config_extra_css" ></textarea>
            <div class="sidenote">' . __('Extra CSS for this player configuration', 'dzsap') . '</div>
        </div>
