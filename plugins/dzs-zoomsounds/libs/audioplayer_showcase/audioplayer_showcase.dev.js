...
//                            console.info(auxa);
            ...
            function change_media(arg, pargs) {
                ...
                if (o.design_skin == 'skin-wave' && skinwave_mode == 'small' && o.change_media_animate_skinwave_mode_small=='on') {
                    ...
                    if(margs.song_name || margs.artist){

                        cthis.find('.meta-artist-con').removeClass('no-meta');
                    }else{
                        cthis.find('.meta-artist-con').addClass('no-meta');
                    }
            ...
            function setup_structure(pargs) {
                ...
                if (o.design_skin == 'skin-wave' && skinwave_mode == 'small') {
                    aux_str_con_controls = '<div class="the-bg"></div><div class="ap-controls-left">'+struct_con_playpause+'</div>'+aux_str_scrubbar+'<div class="ap-controls-right"><div class="controls-volume"><div class="volumeicon"></div><div class="volume_static"></div><div class="volume_active"></div><div class="volume_cut"></div></div><div class="extrahtml-in-float-right">'+o.settings_extrahtml_in_float_right+'</div></div>';
