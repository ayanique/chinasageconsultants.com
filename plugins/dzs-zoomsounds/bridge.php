...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $dzsap->base_url; ?>audioplayer/audioplayer.css"/>
    <link rel="stylesheet" type="text/css" href="<?php echo $dzsap->base_url; ?>libs/dzstooltip/dzstooltip.css"/>
</head>
<body>
<?php
$args = array();
...
?>
<script type="text/javascript" src="<?php echo $dzsap->base_url; ?>audioplayer/audioplayer.js"></script>
</body>
</html>