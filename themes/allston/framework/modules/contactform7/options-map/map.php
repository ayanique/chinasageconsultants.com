...
if ( ! function_exists('allston_eltdf_contact_form_7_options_map') ) {

	function allston_eltdf_contact_form_7_options_map() {
		
		allston_eltdf_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'allston' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = allston_eltdf_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'allston' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = allston_eltdf_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'allston' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'allston' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = allston_eltdf_add_admin_row(
			array(
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'allston' ),
			)
		);
		...
		$typography_text_row2 = allston_eltdf_add_admin_row(
			array(
		...
		$typography_text_row3 = allston_eltdf_add_admin_row(
			array(
		...
		$typography_label_group = allston_eltdf_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'allston' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'allston' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = allston_eltdf_add_admin_row(
			array(
		...
		$typography_label_row2 = allston_eltdf_add_admin_row(
			array(
		...
		$background_border_group = allston_eltdf_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'allston' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'allston' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = allston_eltdf_add_admin_row(
			array(
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'allston' )
			)
		);
		
		$background_border_row2 = allston_eltdf_add_admin_row(
			array(
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'allston' ),
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'allston' )
			)
		);
		
		$background_border_row3 = allston_eltdf_add_admin_row(
			array(
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'allston' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'allston' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = allston_eltdf_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'allston' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = allston_eltdf_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'allston' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'allston' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'allston' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'allston' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = allston_eltdf_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'allston' ),
				'description' => esc_html__( 'Setup form elements margin', 'allston' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = allston_eltdf_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'allston' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'allston' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = allston_eltdf_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'allston' ),
				'description' => esc_html__( 'Setup button text typography', 'allston' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = allston_eltdf_add_admin_row(
			array(
		...
		$button_typography_row2 = allston_eltdf_add_admin_row(
			array(
		...
		$button_background_border_group = allston_eltdf_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'allston' ),
				'description' => esc_html__( 'Setup button background and border style', 'allston' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = allston_eltdf_add_admin_row(
			array(
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'allston' )
			)
		);
		
		$button_background_border_row2 = allston_eltdf_add_admin_row(
			array(
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'allston' )
			)
		);
		
		$button_background_border_row3 = allston_eltdf_add_admin_row(
			array(
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'allston' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'allston' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = allston_eltdf_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'allston')
		));

		//Text Typography

		$typography_text_group = allston_eltdf_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'allston'),
			'description'	=> esc_html__('Setup typography for form elements text', 'allston'),
		...
		$typography_text_row1 = allston_eltdf_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));

		allston_eltdf_add_admin_field(array(
			'parent'		=> $typography_text_row1,
			'type'			=> 'colorsimple',
		...
		$typography_text_row2 = allston_eltdf_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = allston_eltdf_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = allston_eltdf_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'allston'),
			'description'	=> esc_html__('Setup typography for form elements label', 'allston'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = allston_eltdf_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = allston_eltdf_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = allston_eltdf_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'allston'),
			'description'	=> esc_html__('Setup form elements background and border style', 'allston'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = allston_eltdf_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = allston_eltdf_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = allston_eltdf_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = allston_eltdf_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'allston'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = allston_eltdf_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = allston_eltdf_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'allston'),
			'description'	=> esc_html__('Setup form elements margin', 'allston'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = allston_eltdf_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = allston_eltdf_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'allston'),
			'description'	=> esc_html__('Setup button text typography', 'allston'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = allston_eltdf_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = allston_eltdf_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = allston_eltdf_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'allston'),
			'description'	=> esc_html__('Setup button background and border style', 'allston'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = allston_eltdf_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = allston_eltdf_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = allston_eltdf_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = allston_eltdf_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'allston')
        ));
        ...
        $typography_label_row3 = allston_eltdf_add_admin_row(array(
        ...
        $button_typography_row3 = allston_eltdf_add_admin_row(array(
	...
	add_action( 'allston_eltdf_options_map', 'allston_eltdf_contact_form_7_options_map', 20);
}