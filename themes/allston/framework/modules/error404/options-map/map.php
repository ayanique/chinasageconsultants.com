...
if ( ! function_exists( 'allston_eltdf_error_404_options_map' ) ) {
	function allston_eltdf_error_404_options_map() {
		
		allston_eltdf_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'allston' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = allston_eltdf_add_admin_panel(
			array(
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a border bottom color for header area', 'allston' )
			)
		);
		...
		$panel_404_options = allston_eltdf_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'allston' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'name'          => '404_title',
				'default_value' => '',
				'label'         => esc_html__( 'Title', 'allston' ),
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'allston' )
			)
		);
		...
		$first_level_group = allston_eltdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'allston' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'name'          => '404_subtitle',
				'default_value' => '',
				'label'         => esc_html__( 'Subtitle', 'allston' ),
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'allston' )
			)
		);
		...
		$second_level_group = allston_eltdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'allston' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'allston' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'allston' )
			)
		);
		...
		$third_level_group = allston_eltdf_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'allston' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'allston' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'allston' )
			)
		);
		...
		allston_eltdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Skin', 'allston' ),
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'allston' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'allston' ),
					'light-style' => esc_html__( 'Light', 'allston' )
				)
			)
		);
	}
	
	add_action( 'allston_eltdf_options_map', 'allston_eltdf_error_404_options_map', 17 );
}