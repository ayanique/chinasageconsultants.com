...
if( !function_exists('allston_eltdf_get_blog_single_holder_classes') ) {
    /**
     * Function that generates blog holder classes for single blog page
     */
    function allston_eltdf_get_blog_single_holder_classes($classes) {
        $sidebar_classes   = array();
        $sidebar_classes[] = 'eltdf-grid-huge-gutter';
    ...
    add_filter( 'allston_eltdf_blog_single_holder_classes', 'allston_eltdf_get_blog_single_holder_classes' );
}
