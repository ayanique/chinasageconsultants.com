<?php
namespace AllstonCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'allston' ),
				'base'                      => $this->base,
				'icon'                      => 'icon-wpb-blog-list extended-custom-icon',
				'category'                  => esc_html__( 'by ALLSTON', 'allston' ),
				'allowed_container_element' => 'vc_row',
				'params'                    => array(
					array(
						'type'        => 'dropdown',
						'param_name'  => 'type',
						'heading'     => esc_html__( 'Type', 'allston' ),
						'value'       => array(
							esc_html__( 'Standard', 'allston' ) => 'standard',
							esc_html__( 'Boxed', 'allston' )    => 'boxed',
							esc_html__( 'Masonry', 'allston' )  => 'masonry',
							esc_html__( 'Simple', 'allston' )   => 'simple',
							esc_html__( 'Minimal', 'allston' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'allston' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'number_of_columns',
						'heading'    => esc_html__( 'Number of Columns', 'allston' ),
						'value'      => array(
							esc_html__( 'One', 'allston' )   => '1',
							esc_html__( 'Two', 'allston' )   => '2',
							esc_html__( 'Three', 'allston' ) => '3',
							esc_html__( 'Four', 'allston' )  => '4',
							esc_html__( 'Five', 'allston' )  => '5'
						),
					...
					array(
						...
						'heading'     => esc_html__( 'Space Between Items', 'allston' ),
					...
					array(
						'type'        => 'dropdown',
						'param_name'  => 'orderby',
						'heading'     => esc_html__( 'Order By', 'allston' ),
					...
					array(
						'type'        => 'dropdown',
						'param_name'  => 'order',
						'heading'     => esc_html__( 'Order', 'allston' ),
					...
					array(
						'type'        => 'autocomplete',
						'param_name'  => 'category',
						'heading'     => esc_html__( 'Category', 'allston' ),
						'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'allston' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'image_size',
						'heading'    => esc_html__( 'Image Size', 'allston' ),
						'value'      => array(
							esc_html__( 'Original', 'allston' )  => 'full',
							esc_html__( 'Square', 'allston' )    => 'allston_eltdf_square',
							esc_html__( 'Landscape', 'allston' ) => 'allston_eltdf_landscape',
							esc_html__( 'Portrait', 'allston' )  => 'allston_eltdf_portrait',
							esc_html__( 'Thumbnail', 'allston' ) => 'thumbnail',
							esc_html__( 'Medium', 'allston' )    => 'medium',
					...
					array(
						...
						'heading'    => esc_html__( 'Title Tag', 'allston' ),
						'value'      => array_flip( allston_eltdf_get_title_tag( true ) ),
						'group'      => esc_html__( 'Post Info', 'allston' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'title_transform',
						'heading'    => esc_html__( 'Title Text Transform', 'allston' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'allston' ),
						'description' => esc_html__( 'Number of characters', 'allston' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'allston' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'allston' ),
						'value'      => array_flip( allston_eltdf_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'allston' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'allston' ),
						'value'      => array_flip( allston_eltdf_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'allston' ),
						'value'      => array_flip( allston_eltdf_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'allston' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'allston' ),
						'value'      => array_flip( allston_eltdf_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'allston' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'allston' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'allston' ),
						'value'      => array_flip( allston_eltdf_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'allston' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'allston' ),
						'value'      => array_flip( allston_eltdf_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'allston' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'allston' ),
						'value'      => array(
							esc_html__( 'None', 'allston' )            => 'no-pagination',
							esc_html__( 'Standard', 'allston' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'allston' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'allston' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'allston' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		allston_eltdf_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function blogCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'allston' ) . ': ' . $value['category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $category ) ) {
				...
				if ( ! empty( $category_title ) ) {
					$category_title_display = esc_html__( 'Category', 'allston' ) . ': ' . $category_title;
				}
