 ...
 */
if ( ! class_exists( 'AllstonEltdfSidebar' ) ) {
	class AllstonEltdfSidebar {
		var $sidebars = array();
		var $stored = "";
		...
		function __construct() {
			...
			$this->title  = esc_html__( 'Custom Widget Area', 'allston' );
		...
		function load_assets() {
			...
			wp_enqueue_script( 'allston-eltdf-sidebar', ELATED_ROOT . '/framework/admin/assets/js/eltdf-ui/eltdf-sidebar.js' );
			wp_enqueue_style( 'allston-eltdf-sidebar', ELATED_ROOT . '/framework/admin/assets/css/eltdf-sidebar.css' );
		}
		...
		function template_add_widget_field() {
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_attr__('Enter Name of the new Widget Area', 'allston') . "' name='eltdf-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='" . esc_attr__('Add Widget Area', 'allston') . "' />";
			echo "\n    " . $nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars() {
			...
			$args = apply_filters( 'allston_eltdf_custom_widget_args', $args );
