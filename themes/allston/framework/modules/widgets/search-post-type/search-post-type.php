...
class AllstonEltdfSearchPostType extends AllstonEltdfWidget {
	public function __construct() {
		parent::__construct(
			'eltdf_search_post_type',
			esc_html__( 'Elated Search Post Type', 'allston' ),
			array( 'description' => esc_html__( 'Select post type that you want to be searched for', 'allston' ) )
		);
	...
	public function widget( $args, $instance ) {
		...
		<div class="widget eltdf-search-post-type-widget">
			<div data-post-type="<?php echo esc_attr( $post_type ); ?>" <?php allston_eltdf_class_attribute( $search_type_class ); ?>>
				<input class="eltdf-post-type-search-field" value="" placeholder="<?php esc_attr_e( 'Search here', 'allston' ) ?>">
