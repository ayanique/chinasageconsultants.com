...
class AllstonEltdfSimpleLineIcons implements iAllstonEltdfIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'allston'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'allston'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'allston'),
            'icon-social-facebook'    => esc_html__('Facebook', 'allston'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'allston'),
            'icon-social-github'      => esc_html__('Github', 'allston'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'allston'),
            'icon-social-instagram'   => esc_html__('Instagram', 'allston'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'allston'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'allston'),
            'icon-social-reddit'      => esc_html__('Reddit', 'allston'),
            'icon-social-skype'       => esc_html__('Skype', 'allston'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'allston'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'allston'),
            'icon-social-spotify'     => esc_html__('Spotify', 'allston'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'allston'),
            'icon-social-twitter'     => esc_html__('Twitter', 'allston'),
            'icon-social-youtube'     => esc_html__('Youtube', 'allston')
        );
    }
